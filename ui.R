...
shinyUI(
  dashboardPage(
    ...
    dashboardBody(
      tabItems(
        tabItem(tabName = "toxkmeans",h4("K-Means (applied to 141 chemicals)"),
               fluidRow(column(12,
        ...
        tabItem(tabName = "toxhierarchical", h4("Hierarchical Clustering (applied to 141 chemicals)"),
                fluidRow(column(
                  height = 12,
                  width = 12
                ),
        ...
        tabItem(tabName = "toxpi", h4("Toxicity Charts"),
                ...
                tabBox(width='100%', height='100%',id="tabchart4",
                       ...
                       tabPanel("OrdinalNET",  
                                fluidPage(
                                  selectInput("user_slices", "Please select number of chemical substances per slice (Info: The available sample sizes are 49, 56, 63, 70 and 77 and are calculated as the number of independent variables (7 have been chosen in the initial model and in the regression) multiplied with the number of chemical substances per slice (7, 8, 9, 10 or 11)):", choices = c(7, 8, 9, 10, 11)),
        ...
        tabItem(tabName = "toxpca", h4("Principal Component Analysis (applied to 141 chemicals)"),
                fluidRow(  column(
                  height = 12,
                  width = 12
                ),
                  tabBox(width='100%', height='100%',id="tabchart3",
                         ...
                         tabPanel("% of explained variance", plotOutput('plot_4')),
...
#(nams): identifying and overcoming hurdles to accelerated adoption,” Toxicology Research, 
#vol. 13, 03 2024.

#[3] J. F. Fleming, D. L. Filer, D. T. Lloyd, P. Thunga, S. W. Marvel, A. A.
#Motsinger-Reif, and D. M. Reif, “toxpir: Create toxpi prioritization models,” 2024d. R package,
#version 1.3.0, https://cran.r-project.org/web/packages/toxpiR/index.html.
...
#[10] C. B. Pestana, J. W. Firman, and M. T. Cronin, “Incorporating lines of evidence 
#from new approach methodologies (nams) to reduce uncertainties in a
...
#  Reif, and D. M. Reif, “Toxpi r introduction,” 2024b. 
#https://cran.rstudio.com/web/packages/toxpiR/vignettes/introduction.html#:~:text=What%20is%20ToxPi%3F,i.e.%20multimodal%20or%20multiscale%20information, accessed on 2024-11-21.
...
#[20] O. C. Ifegwu and C. Anyakora, “Chapter six - polycyclic aromatic hydrocarbons: Part i. exposure,” 
#in Advances in Clinical Chemistry (G. S. Makowski,
...
#[25] S. Karnouskos, R. Sinha, P. Leit˜ao, L. Ribeiro, and T. I. Strasser, 
#“The applicability of iso/iec 25023 measures to the integration of agents and automation
...
#[27] International Organization for Standardization (ISO) and International Electrotechnical Commission (IEC),
...
#[28] T. Galli, F. Chiclana, and F. Siewe, “Software product quality models, developments, trends, and evaluation,” 
#SN Computer Science, vol. 1, 05 2020.
...
#[37] D. Jurafsky and J. H. Martin, Speech and Language Processing: An Introduction to Natural Language 
#Processing, Computational Linguistics, and Speech
#Recognition with Language Models. published at: https://web.stanford.edu/~jurafsky/slp3/, 3rd ed., 2025. 
#Online manuscript released January 12, 2025.

#[38] M. J. Wurm, P. J. Rathouz, and B. M. Hanlon, “ordinalnet: Penalized ordinal regression,” 2022. 
#R package version 2.12, https://cran.r-project.org/web/packages/ordinalNet/index.html.

#[39] B. Ripley, B. Venables, D. M. Bates, K. Hornik, A. Gebhardt, and D. Firth, 
#“Mass: Support functions and datasets for venables and ripley’s mass,” 2025. 
#R package, version 7.3-64, https://cran.r-project.org/web/packages/MASS/index.html.

#[40] H. Wickham, W. Chang, L. Henry, T. L. Pedersen, K. Takahashi, C. Wilke, 
#K. Woo, H. Yutani, D. Dunnington, and T. van den Brand, ggplot2: Create Elegant 
#Data Visualisations Using the Grammar of Graphics, 2024. 
#R package version 3.5.1, https://cran.r-project.org/web/packages/ggplot2/index.html.

#[41] Y. Xie, J. Cheng, X. Tan, J. Allaire, M. Girlich, G. F. Ellis, J. Rauh, 
#S. Limited, B. Reavis, L. Gersen, B. Szopka, A. Pickering, W. Holmes, M. Marttila, 
#A. Quintero, and S. Laurent, DT: A Wrapper of the JavaScript Library ’DataTables’, 
#2024. R version 0.33, https://cran.r-project.org/web/packages/DT/index.html.

#[42] B. Auguie and A. Antonov, gridExtra: Miscellaneous Functions for ”Grid” Graphics, 
#2017. R package version 2.3, https://cran.r-project.org/web/packages/gridExtra/index.html.

#[43] S. Marvel and D. M. Reif, “Toxpi™ user manual v2.3,” 2018.
#https://toxpi.org/dist/ToxPi%20User%20Manual.pdf, accessed on 2024-11-21.

#[44] J. Fleming, D. Filer, D. Lloyd, P. Thunga, S. W. Marvel, 
#A. A. Motsinger-Reif, and D. M. Reif, “Manual package ‘toxpir’,” 2024c.
#https://cran.r-project.org/web/packages/toxpiR/toxpiR.pdf, accessed on 2024-11-21.

#[45] A. Kassambara and F. Mundt, “factoextra : Extract and visualize the results of 
#multivariate data analysesg,” 2020. https://cran.r-project.org/web/packages/factoextra/readme/README.html.

#[46] J. R. Groff, P. N. Weinberg, and A. J. Oppel, SQL: The Complete Reference, Third Edition. McGraw-Hill, 2010.

#[47] S. Parth, “Understanding k-means and hierarchical clustering in r,” 2020.
#https://medium.com/@shreytparth/understanding-k-means-and-hierarchical-clustering-in-r-9899342cc4fb, accessed on 2024-11-21.

#[48] Z. Keita, “Introduction to principal component analysis (pca),” 2023.
#https://www.datacamp.com/tutorial/pca-analysis-r.

#[49] A. Kassambara, “Pca - principal component analysis essentials,” 2017.
...
#[50] “R shiny tutorial — r shiny dashboard —enabling menu items for their
#respective pages — r programming.” Data ScienceTutorial, 2017. https://www.youtube.com/watch?v=fUXBL5bk20M.

#[51] “Shiny web app tutorial — how to upload a file in shiny app — r programming tutorial.” 
#Data Science Tutorial, 2020. https://www.youtube.com/watch?v=A6VYSCB0TZM&t=199s.

#[52] “R shiny basics and user interface.” Statistical Learning Group, 2020.
#https://www.youtube.com/watch?v=6mJaw5pLtso.

#[53] Y. Dai and Y. Xiang, “Connecting sqlite database and shiny app for business intelligence,”
#2020. https://shanghai.hosting.nyu.edu/data/r/case-3-sql-shiny.html, accessed on 2024-11-21.
